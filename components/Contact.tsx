              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white">ilyesfradi0@gmail.com</p>
                  </div>
                </a>
                <a
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-white">+216 54 310 930</p>
                  </div>
                </a>
                <a
                  ...
                  className="flex items-center gap-4 text-gray-400 hover:text-white transition-colors duration-200 group"
                >
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                    <Github size={20} className="text-white" />
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">GitHub</p>
                    <p className="text-white">github.com/IlyesFradi01</p>
                  </div>
                </a>
                <a
                  ...
                  className="flex items-center gap-4 text-gray-400 hover:text-white transition-colors duration-200 group"
                >
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                    <Linkedin size={20} className="text-white" />
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">LinkedIn</p>
                    <p className="text-white">linkedin.com/in/fradi-ilyes</p>
                  </div>
                </a>
              </div>
            </div>
